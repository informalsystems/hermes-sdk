// Copied from https://github.com/cosmos/ibc-proto-rs/blob/luca_joss/solomachine-lightclient-v3-from-v0.32/src/prost/ibc.lightclients.solomachine.v2.rs
...
pub struct ClientStateData {
    ...
    pub client_state: ::core::option::Option<Any>,
}
...
pub struct ConsensusStateData {
    ...
    pub path: ::prost::alloc::vec::Vec<u8>,
    #[prost(message, optional, tag = "2")]
    pub consensus_state: ::core::option::Option<Any>,
}
...
pub struct ConnectionStateData {
    ...
    pub path: ::prost::alloc::vec::Vec<u8>,
    #[prost(message, optional, tag = "2")]
    pub connection: ::core::option::Option<ibc_proto::ibc::core::connection::v1::ConnectionEnd>,
}
...
pub struct ChannelStateData {
    ...
    pub path: ::prost::alloc::vec::Vec<u8>,
    #[prost(message, optional, tag = "2")]
    pub channel: ::core::option::Option<ibc_proto::ibc::core::channel::v1::Channel>,
}
